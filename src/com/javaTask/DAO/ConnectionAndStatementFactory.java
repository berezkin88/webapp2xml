...
public class ConnectionAndStatementFactory {
	...
	protected static Connection connecting() {
		...
		try {
			...
			LOG.info("Exception occures when registering file in ConnectionAndStatementFactory \n");
			e.printStackTrace();
		} catch (SQLException e) {
			LOG.info("Exception occures when connecting to DB in ConnectionAndStatementFactory \n" + e.toString());
		}
